...
public class ArrayList_LoopPractice {
    ...
    public static void main(String[] args) {
        ...
        // then loop through each name and check whether character count equal to longestWord character count
        ...
        // length   : counting the elements inside an Array, it's a property of array object
                  // last item of an array : arr[arr.length-1]
        // length() : counting the characters inside a String, it's a method of String object
