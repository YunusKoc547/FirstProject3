...
public class ExceptionPractice {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // getMessage is a method coming from Exception class and provide some more details exception object
        ...
        // and we can create object ourselves, so it has it's own class
