    ...
    public static void main(String[] args) {
        ...
        for (String eachCar : carInventory) {
            if (eachCar.startsWith("Chevrolet")) {
                chevyCount += 1;
            }else if (eachCar.endsWith("Civic")) {
                civicCount += 1;
            }
        }
...
//        }
        ...
        // find all the cars with model that has only 2 characters
        // print it out
        // get the count
        int twoDigitCarCount = 0;
        for (String eachCar : carInventory) {
            String[] split = eachCar.split("-",2);
            String model = split[1];
            if (model.length() == 2) {
                twoDigitCarCount++;
                System.out.println(twoDigitCarCount + " - " + eachCar);
            }
        }

        Arrays.sort(carInventory);
        System.out.print("carInventory = " + Arrays.toString(carInventory));
