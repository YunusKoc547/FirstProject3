...
public class FruitShop {
    ...
    public static void main(String[] args) {
        ...
        // a1 has Apple as reference type, so we can access anything inside
        ...
        // because only reference type decides what you can access
        f1 = new Orange("sour-sweet","reddish",11);
        f1.getDigested();
